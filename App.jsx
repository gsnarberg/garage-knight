...
const CAR_DB = [
  ...
  { name: "Toyota GR86 / Subaru BRZ", years: "2022–2024", avail: "both", priceLow: 27000, priceHigh: 36000,
    ...
    watchOut: "Back seats are essentially cargo shelves; engine note is more buzzy than musical.",
    proTip: "The 2022+ second-gen fixed the old torque dip — worth seeking over the first-gen." },
  ...
  { name: "Honda Civic (incl. Si / Type R)", years: "2016–2024", avail: "both", priceLow: 15000, priceHigh: 45000,
    ...
    visceral: "Right-sized and genuinely engaging — the Si and Type R turn the everyday Civic into a giant-killer.",
    watchOut: "Base trims are sensible but plain; the hot versions can carry dealer markups.",
    proTip: "A used Si is the enthusiast value play — most of the fun, far less than a Type R." },
  ...
  { name: "BMW iX / i4", years: "2022–2024", avail: "both", priceLow: 42000, priceHigh: 75000,
    body: "suv", drive: "smooth", aesthetic: ["sculpted","minimal"], cabin: ["tech","quiet","premium","sound"],
    reliability: "mid", techComplexity: "high", depreciation: "high", efficiency: "high", uniqueness: "mid", seats: 5, luxury: true,
    visceral: "A serene electric lounge — hushed, beautifully finished, and effortlessly quick when you ask.",
    watchOut: "Polarizing styling and heavy reliance on screens; depreciation is steep.",
    proTip: "Used EV depreciation makes these a bargain — let the first owner take the hit." },
  ...
  { name: "Acura TLX / Integra", years: "2021–2024", avail: "both", priceLow: 28000, priceHigh: 52000,
    body: "sedan", drive: "balanced", aesthetic: ["aggressive","sculpted"], cabin: ["premium","sound","seats"],
    reliability: "high", techComplexity: "mid", depreciation: "mid", efficiency: "mid", uniqueness: "mid", seats: 5, luxury: true,
    visceral: "Sharp-suited and reliable — the Type S models add real bite, with a stellar sound system standard.",
    watchOut: "Touchpad infotainment is fiddly; rear seat is snug.",
    proTip: "The Type S delivers near-premium performance with Honda-grade dependability." },
  ...
  { name: "Toyota Land Cruiser / Lexus GX", years: "2014–2024", avail: "both", priceLow: 35000, priceHigh: 80000,
    body: "suv", drive: "commanding", aesthetic: ["rugged","elegant"], cabin: ["quiet","premium","visibility","seats"],
    reliability: "high", techComplexity: "low", depreciation: "low", efficiency: "low", uniqueness: "high", seats: 7, luxury: true,
    visceral: "Goes anywhere, lasts forever, and feels like a vault — quietly the most over-engineered SUV you can buy.",
    watchOut: "Drinks fuel and the ride is old-school; tech is deliberately basic.",
    proTip: "Legendary durability means even high-mileage examples command strong prices for good reason." },
  { name: "Volkswagen GTI / Golf R", years: "2015–2024", avail: "both", priceLow: 16000, priceHigh: 42000,
    ...
    visceral: "The do-everything enthusiast hatch — fun, fast, and practical enough to be your only car.",
    watchOut: "Newer models moved to fussy touch controls; some turbo upkeep to budget for.",
    proTip: "A used MK7 GTI (2015–2021) with physical buttons is the enthusiast's pick." },
  { name: "Hyundai Santa Fe / Tucson", years: "2019–2024", avail: "both", priceLow: 16000, priceHigh: 40000,
    body: "suv", drive: "smooth", aesthetic: ["sculpted","minimal"], cabin: ["seats","quiet","visibility","tech"],
    reliability: "high", techComplexity: "mid", depreciation: "mid", efficiency: "high", uniqueness: "mid", seats: 5, luxury: false,
    visceral: "Comfortable, well-equipped, and easy to live with — a lot of modern SUV for sensible money.",
    watchOut: "Some engine families had reliability recalls — check service history carefully.",
    proTip: "The hybrid versions are efficient and come with strong remaining warranties used." },
  ...
  { name: "Honda CR-V / Toyota RAV4", years: "2018–2024", avail: "both", priceLow: 18000, priceHigh: 40000,
    body: "suv", drive: "smooth", aesthetic: ["minimal","rugged"], cabin: ["seats","visibility","simple","quiet"],
    reliability: "high", techComplexity: "low", depreciation: "low", efficiency: "high", uniqueness: "low", seats: 5, luxury: false,
    visceral: "The sensible-shoe choice that quietly nails it — roomy, frugal, and almost impossible to wear out.",
    watchOut: "Appliance-like to drive; you buy these with your head, not your heart.",
    proTip: "Hybrid versions add efficiency and resale strength for a small premium." },
  // ─── Electric ───
  { name: "Hyundai Ioniq 5 / Kia EV6", years: "2022–2024", avail: "both", priceLow: 28000, priceHigh: 52000,
    ...
    visceral: "Spaceship-smooth and silent, with blisteringly fast charging and a roomy, lounge-like cabin.",
    watchOut: "Best if you can charge at home — public charging is improving but still variable.",
    proTip: "Used examples have dropped sharply; a nearly-new one can be a serious bargain." },
  ...
  { name: "Rivian R1S / R1T", years: "2022–2024", avail: "both", priceLow: 55000, priceHigh: 95000,
    ...
    visceral: "An electric adventure machine — silent, hugely capable off-road, and full of clever design touches.",
    watchOut: "Big, heavy, pricey to insure, and the service network is still growing.",
    proTip: "The R1S seats the family; the R1T is the pickup version if you want a bed." },
  ...
  { name: "Chevrolet Tahoe / Suburban", years: "2021–2024", avail: "both", priceLow: 45000, priceHigh: 90000,
    ...
    visceral: "Three rows of genuine space plus serious towing — the Suburban swallows a whole family's worth of gear and then some.",
    watchOut: "Big and thirsty; the base engine works hard when loaded.",
    proTip: "The diesel returns shockingly good highway mpg for something this size." },
