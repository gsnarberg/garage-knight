          ...
          {results.more && results.more.length > 0 && (
            <div style={{ marginTop: 30 }}>
              ...
              {results.more.map((car) => (
                <div key={car._key} style={{ display: "flex", alignItems: "center", justifyContent: "space-between",
                  ...
                  <span style={{ flexShrink: 0, fontSize: 12.5, fontWeight: 600, fontFamily: "'DM Sans', sans-serif",
                    color: car.newOrUsed === "used" ? "#82ad6a" : "#cfaa5a" }}>{car.newOrUsed} · {car.priceRange}</span>
                </div>
              ))}
            </div>
          )}
